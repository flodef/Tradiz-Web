      ...
      <main className="flex-1">
        <section className="w-full pt-12 md:pt-24 lg:pt-32 border-y">
          <div className="container space-y-10 px-4 sm:px-6 md:space-y-16 lg:px-10">
            <div className="grid max-w-[1300px] mx-auto items-start gap-4 md:grid-cols-2 md:gap-16">
              ...
              <div className="flex flex-col items-start space-y-4">
                <div className="space-y-4">
                  <p className="text-sm font-medium tracking-wide">Schedule a Demo</p>
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl lg:text-5xl/none">See it in action</h2>
                </div>
                <form className="grid gap-4 md:grid-cols-2">
                  <input className="border-gray-200" placeholder="Name" type="text" />
                  <input className="border-gray-200" placeholder="Email" type="email" />
                  <input className="border-gray-200" placeholder="Company" type="text" />
                  <input className="border-gray-200" placeholder="Phone" type="tel" />
                  <button className="w-full md:col-start-2" type="submit">
                    Get Started
                  </button>
                </form>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container space-y-12 px-4 md:px-6">
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl">
              <div className="mx-auto rounded-lg object-cover object-center aspect-video overflow-hidden sm:order-last" />
